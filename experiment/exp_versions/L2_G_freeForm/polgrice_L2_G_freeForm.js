...
function doSentSubs(sents, polite, domain, utterance, people, goal) {
    ...
    question2 = "Based on what SP said, what do you think <b>SP's goal</b> was?"
        //    question2 = "How would SP <b>actually</b> rate LS's BB? <br>Please select the number of stars you think SP would actually give:";
    question = "What do you think <b>LS's goal</b> was in asking about the BB?"
    ...
    next: function () {
        ...
        if (window.self == window.top | turk.workerId.length > 0) {
            ...
            if (numComplete > 0) {
                ...
                experiment.data.goal.push(document.getElementById("listenerGoalInference").value);
                experiment.data.goal.push(document.getElementById("speakerGoalInference").value);
