...
var utterances = shuffle(utterances1.concat(utterances2, utterances1, utterances2, utterances1, utterances2))
...
//
    ...
    utterances: {
        yes_terrible: {
            sent_utterance: "\"It was terrible\""
        },        
        yes_bad: {
            sent_utterance: "\"It was bad\""
        },        
        yes_okay: {
            sent_utterance: "\"It was okay\""
        },        
        yes_good: {
            sent_utterance: "\"It was good\""
        },        
        yes_amazing: {
            sent_utterance: "\"It was amazing\""
        },
        not_terrible: {
            sent_utterance: "\"It wasn't terrible\""
        },        
        not_bad: {
            sent_utterance: "\"It wasn't bad\""
        },        
        not_okay: {
            sent_utterance: "\"It wasn't okay\""
        },        
        not_good: {
            sent_utterance: "\"It wasn't good\""
        },        
        not_amazing: {
            sent_utterance: "\"It wasn't amazing\""
        },
   },
    domains: {
        presentation: {
...
function doSentSubs(sents, polite, domain, utterance, people, goal, blank_utterance) {
    ...
    return [utterance, context, state, precontext, question, question2, question3, knowledge, goal, feeling, context2, blank_utterance];
}
    ...
    next: function () {
        ...
        if (window.self == window.top | turk.workerId.length > 0) {
            ...
            if (numComplete >= numTrials) {
                ...
                showSlide("stage");
                $("#context").html(sent_materials[3] + sent_materials[7] + sent_materials[1] + sent_materials[11]);
