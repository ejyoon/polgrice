...
raw.data.path <- "/Users/ericang/Documents/Research/polite_probmods/polite_adj/experiment/exp_versions/polgrice/goals_v3/production-results/"
...
qplot(utterance, pred_prob, 
  ...
  ylab("likelihood") +
  scale_y_continuous(limits = c(0, 1)) +
  ggtitle("How likely is it for you to ask this person for feedback? / like this person?") +
  geom_errorbar(aes(ymin=pred_prob-cil,ymax=pred_prob+cih,width=.1)) +
  theme(axis.text.x  = element_text(angle=45, vjust=0.5))
