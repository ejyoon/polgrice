...
#                       "model/results/bda-politeRSA-speaker1GivenStateGoal_mixtureWeight-80000burn40000.csv",sep=""), # CHANGE FILE NAME AS NEEDED
#           row.names=FALSE)
...
bda.utterance.results <- fread(paste(local.path,
                        "model/results/bda-politeRSA-speaker1GivenStateGoal_mixtureWeight-80000burn40000.csv",
                        sep = ""))
# 
