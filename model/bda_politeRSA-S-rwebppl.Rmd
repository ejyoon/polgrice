...
write.csv(bda.utterance.results,paste(local.path,
                      "model/results/bda-politeRSA-speaker2GivenStateGoal_mixtureWeight-10000burn5000-factorStateGoal.csv",sep=""), # CHANGE FILE NAME AS NEEDED
          row.names=FALSE)
...
bda.utterance.results <- fread(paste(local.path,
                        "model/results/bda-politeRSA-speaker2GivenStateGoal_mixtureWeight-10000burn5000.csv",
                        sep = ""))
# 
