...
var politeRSA = function(experimentalCondition, opts, RSAparams, priorParams, weights, semantics, queryStatement){
	...
	var speaker1 = cache(function(state, speakerGoals) {
	  Enumerate(function(){
	    ...
	    var mUtility = priorParams.includeMeanness ? speakerGoals.meanness*socialUtility : 0
