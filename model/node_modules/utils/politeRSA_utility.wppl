...
var priorParams = {
	honestGamma : 0.5, honestDelta : 2,
	kindGamma : 0.5, kindDelta : 2,
	meanGamma : 0.5, meanDelta : 2,
	includeMeanness: true
}
...
var politeRSA = function(experimentalCondition, RSAparams, weights, semantics, queryStatement){
	...
	var meaning = function(words, state){
		...
		// console.log(flip(semantics[words][state]))
	    return words=="mu" ? true : flip(semantics[words][state])
	...
	var speaker1 = cache(function(state, speakerGoals, speakerOptimality, alpha) {
	  Enumerate(function(){
	...
	// var listener1 = function(exptCondition, weights, queryStatement) {
	var listener1 = function(exptCondition, weights,alpha, queryStatement) {
	  Enumerate(function(){
	    ...
	    var S1 = speaker1(state, speakerGoals, speakerOptimality, alpha)
	...
	return listener1(experimentalCondition, weights, alpha, queryStatement)
}