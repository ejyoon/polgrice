...
utts_wNull <- c("yes_terrible", "yes_bad", "yes_okay", "yes_good","yes_amazing", "nullUtt")
...
shinyApp(
  ui = fluidPage(
    ...
    fluidRow(
      ...
      selectInput("utterances", "Utterances",
             choices = c("Spoken utterances", "Spoken utterances + null"))
      )),
      plotOutput("rsaPlot")
  ),
  ...
  server = function(input, output) {
    ...
    # utterance set
    utts <- ifelse(input$utterances == "Spoken utterances", utts_woNull, utts_wNull)
    ...
    rsa.output <- webppl(
      program_file = ifelse(input$utterances == "Spoken utterances",
