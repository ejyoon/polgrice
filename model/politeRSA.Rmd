...
shinyApp(
  ui = fluidPage(
      sliderInput("nice_honesty", label = "Nice speaker honesty", min = 0, max = 1, value = .01),
      sliderInput("nice_niceness", label = "Nice speaker niceness", min = 0, max = 1, value = .9),
      sliderInput("mean_honesty", label = "Mean speaker honesty", min = 0, max = 1, value = .5),
      sliderInput("mean_niceness", label = "Mean speaker niceness", min = 0, max = 1, value = .5),
      sliderInput("honest_honesty", label = "Honest speaker honesty", min = 0, max = 1, value = .9),
      sliderInput("honest_niceness", label = "Honest speaker niceness", min = 0, max = 1, value = .01),
      plotOutput("rsaPlot")
  ),
  ...
  server = function(input, output) {
    ...
    rsa.output <- webppl(program_file = paste(local.path, "model/politeRSA_nonegs.js", sep=""),
                         data = dataToWppl,
                         data_var = "dataFromR")
    rsa.output <- 
