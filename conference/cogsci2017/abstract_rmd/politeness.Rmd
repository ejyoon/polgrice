...
We tested the polite RSA model (pRSA) with the case study of *white lies* (\mht{def?}).
...
Thus we defined the overall speaker utility ($U$) to be a weighted combination of epistemic and social utilities.
...
P_{S_1}(w \mid s, \hat{\beta}) &\propto \mathrm{exp}(\lambda_{1} \cdot \mathbb{E}[U(w; s;  \hat{\beta})]) \\
