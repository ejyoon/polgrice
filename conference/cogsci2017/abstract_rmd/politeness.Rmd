...
For instance, "It wasn't amazing" does not preclude the possibility that the presentation was bad, and may in fact be pragmatically strengthened to mean that it was actually bad; yet because the speaker does not choose the more direct utterance ("It was bad") the listener will infer a face-saving goal. 
Thus saying "It wasn't amazing" can accomplish the goal of conveying that the presentation was bad while the speaker is seen as not wanting to make the listener feel bad by explicitly saying so.
