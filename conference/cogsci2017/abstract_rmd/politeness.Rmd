...
While the model in the *both* condition did produce indirect utterances (e.g. "It was not terrible" given 1 heart) it did so sloghtly less that the empirical data.
