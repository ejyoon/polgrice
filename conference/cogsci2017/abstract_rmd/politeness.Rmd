...
We explore the speaker model predictions by assuming particular parameter values (recall that $\phi$ is the parameter governing the mixture of epistemic and social utilities):
