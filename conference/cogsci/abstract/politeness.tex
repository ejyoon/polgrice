...
The model's expected posterior over states when the speaker is trying to be \emph{honest} increase as a function of the positivity implied by the utterances (i.e. \emph{amazing} means a very high state).
...
%First, unlike the model predictions that the inferred states given honesty goal would be more positive throughout,
...
Ratings for niceness and meanness goals were strongly anti-correlated $r = X$.
...
%We discuss the behavioral results in tandem with the model predictions.
