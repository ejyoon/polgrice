...
Specifically, we found that people expect the rating that a performance actually deserves
to depend on what the speaker said and whether the speaker's intended goal was to be honest, nice or mean. 
We also found that people attribute goals to speakers differentially based on 
...
Politeness is not a phenomenon that deviates from rational communication,
it is rather what makes human communication most rational, in serving a key social function of maintaining relationships.
