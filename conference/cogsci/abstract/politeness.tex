...
Intuitively, politeness is what differentiates human speech from stereotyped robot communication, 
which can only try to follow rules to say ``please'' or ``thank you'' but not be genuinely ``polite.'' 

Must this mean that people are not cooperative communicators? \citeA{Brown1987} recast the notion of ``cooperative speaker'' as a speaker
