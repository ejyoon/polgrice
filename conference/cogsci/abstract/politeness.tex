...
and their comparison against predictions by our computational model corroborate this argument.
...
We consider states which have utility values 1 - 5, corresponding to the subjective utility of the state, and roughly corresponding to the scalar value terms \{\emph{good}, \emph{bad}, \emph{terrible}, \emph{amazing}, and \emph{okay}\}. \ejy{should the order of words be kept consistent? terrible-bad-okay-good-amazing? (matching utility 1-5)} 
...
% $\{w_{amazing}, w_{bad}, w_{okay}, w_{good}, w_{amazing}\}$
  \mht{used in relevant empirical studies (Bonnefon ?).}
   ...
   \ejy{also, same comment as above about word ordering}
\end{enumerate}
