...
Within our experimental domain (e.g.~Fig.~\ref{fig:ex}), we assume: There are five states of the world $S = \{s_{1}, ...,  s_{5}\}$.
...
Overall, the model explains a lot the variance in the mean data $r^2(15) = 0.91$. 
...
The model predicts the full distribution with high accuracy $r^2(75) = 0.79$, and even higher among just the goals to be honest and nice $r^2(50) = 0.86$.
