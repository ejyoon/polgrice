...
The situation above represents what \citeA{Brown1987} identified as a \emph{face-threatening act} (FTA), which intrinsically threatens the listener's positive face, or their positive self-image. They argue that, the speaker will take into consideration weightings of three wants: (a) to communicate the content of the FTA; (b) to save the listener's face; and (c) to be urgent or efficient. We consider (b) to be irrelevant in the current situation, and revisit the ideas in (a) and (b). Specifically, we posit that, in a situation where a speaker is called to remark on and evaluate the listener's performance, there are two kinds of goals a speaker has: (1) To be ``honest''Äô (vs. ``dishonest''Äô): to convey the true state of the world as truthfully and accurately as possible (vs. to hide it); (2) To be ``nice''Äô (vs. ``mean''): to make the listener feel good about themselves and save the listener's face (vs. to make them feel bad and lose face)
...
The current work is the first attempt, to our knowledge, to empirically test people's lay notion of politeness as a way to balance between conveying accurate information and saving the interactants'ô positive face (\emph{epistemic utility} and \emph{social utility} respectively; discussed in Computational Model section below). We also present a formal model of a listener to thinks about a speaker who considers both the goals of improving the knowledge state of the listener and making the listener feel good about him- or herself. 
